...
Given("a list of task in the application for get by id", function () {
...
When('the user wants to get a task with id {string}', async function (id) {
  this.task = await this.taskService.getTaskById(id);
});

Then('get by id {string}', function (result) {
